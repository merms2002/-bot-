let handler = async (m, { conn, participants, usedPrefix, command }) => {
    ...
    let ownerJids = ['201114571370@s.whatsapp.net', '21228616765@s.whatsapp.net'] // أرقام المطورين

    let botNumber = '201103896260@s.whatsapp.net' // رقم البوت اللي ممنوع طرده
